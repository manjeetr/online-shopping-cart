...
def print_description(
    def_: GraphQLArgument | GraphQLDirective | GraphQLEnumType | GraphQLEnumValue | GraphQLInputObjectType | GraphQLInterfaceType | GraphQLObjectType | GraphQLScalarType | GraphQLUnionType,
    indentation: str = "",
